...
OUTPUT_DIR = '/Users/sanjeev/Library/CloudStorage/OneDrive-OldDominionUniversity/CS733/MIMIC-III/preproc_data/' #this path will contain tokenized notes. This dir will be the input dir for create_pretrain_data.sh
MIMIC_NOTES_FILE = '/Users/sanjeev/Library/CloudStorage/OneDrive-OldDominionUniversity/CS733/MIMIC-III/orig_data/NOTEEVENTS.csv.gz' #this is the path to mimic data if you're reading from a csv. Else uncomment the code to read from database below
...
def process_note_helper(note):
    ...
    # section_frame.apply(process_section, args=(note, processed_sections))
...
notes = pd.read_csv(MIMIC_NOTES_FILE, index_col = 0, nrows=3)
...
# formatted_notes = notes.progress_apply(process_note)
